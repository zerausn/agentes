...
# ================================================================
# 6_SUBIR_TIKTOK_GHAWAZEE_180 — Evacuador TikTok rapido Ghawazee (sin API)
#
# Sube 1 video cada 180s (3 min) desde:
#   /sdcard/Antigravity/completados_shirabyoshi
#
...
SESSION_LOG="$LOG_DIR/6_SUBIR_TIKTOK_GHAWAZEE_180.log"
SOURCE_DIR="/sdcard/Antigravity/completados_shirabyoshi"
DONE_DIR="/sdcard/Antigravity/completados_ghawazee"
ADB_SERIAL="127.0.0.1:5555"
VIGIA_LOCK="$TERMUX_HOME/vigia_tiktok_ghawazee_180.lock"
TIKTOK_GLOBAL_LOCK="$TERMUX_HOME/vigia_tiktok_global.lock"
TIKTOK_VIGIA_NAME="6_SUBIR_TIKTOK_GHAWAZEE_180"
...
echo ""
echo "=============================================="
echo "  6_SUBIR_TIKTOK_GHAWAZEE_180 — TikTok cada 3 min (Ghawazee)"
