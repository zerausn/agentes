...
# ================================================================
# 6_SUBIR_TIKTOK_GHAWAZEE — Evacuador TikTok Ghawazee (sin API)
#
...
echo ""
echo "=============================================="
echo "  6_SUBIR_TIKTOK_GHAWAZEE — TikTok por app (Ghawazee 720s)"
