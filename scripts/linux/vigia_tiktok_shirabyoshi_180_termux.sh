...
# ================================================================
# 6_SUBIR_TIKTOK_SHIRABYOSHI_180 — Evacuador TikTok rapido Shirabyoshi (sin API)
#
...
SESSION_LOG="$LOG_DIR/6_SUBIR_TIKTOK_SHIRABYOSHI_180.log"
...
echo ""
echo "=============================================="
echo "  6_SUBIR_TIKTOK_SHIRABYOSHI_180 — TikTok cada 3 min (Shirabyoshi)"
