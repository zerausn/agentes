...
EXTERNAL_SRC = Path("/media/zerausn/D69493CF9493B08B/Users/ZN-/Documents/ADM/Carpeta 1/videos subidos exitosamente")
EXTERNAL_DST = Path("/media/zerausn/D69493CF9493B08B/Users/ZN-/Documents/ADM/Carpeta 1/ya_subidos_fb_ig")
...
def reconcile_folder(folder_path, label):
    ...
    # 1. CACHE DE LIBRERIA
    from meta_uploader import get_facebook_library_batch
    fb_cache = get_facebook_library_batch(max_pages=80) or []
    ...
    for file_path in files:
        ...
        if is_in_local_success or is_in_fb:
            reason = "Local Folder" if is_in_local_success else "Facebook"
