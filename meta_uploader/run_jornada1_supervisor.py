...
def main():
    ...
    while True:
        ...
        if calendar_state["all_completed"]:
            ...
            logging.info("Lanzando clasificador de videos para Meta...")
            vroot = "/media/zerausn/D69493CF9493B08B/Users/ZN-/Documents/ADM/Carpeta 1/videos subidos exitosamente"
            subprocess.run([sys.executable, str(BASE_DIR / "classify_meta_videos.py"), vroot], cwd=BASE_DIR)
