...
VIGIA="/data/data/com.termux/files/home/agentes/scripts/linux/vigia_tiktok_shirabyoshi_180_termux.sh"
SESSION_LOG="/sdcard/Antigravity/widget_logs/6_SUBIR_TIKTOK_SHIRABYOSHI_180.log"
LAUNCH_LOG="/sdcard/Antigravity/widget_logs/6_SUBIR_TIKTOK_SHIRABYOSHI_180_launcher.log"
if [ ! -f "$VIGIA" ]; then
