...
class VideoHelpersTests(unittest.TestCase):
    ...
    def test_extract_teaser_sequence_normalizes_source_and_uses_one_based_numbers(self):
        self.assertEqual(
            extract_teaser_sequence("slice_60s_20260414_170022_teaser_000.mp4"),
            ("20260414_170022", 1),
        )
        self.assertEqual(
            extract_teaser_sequence("ig_compat_20260414_170022_teaser_014"),
            ("20260414_170022", 15),
        )
        self.assertEqual(extract_teaser_sequence("clip_suelto.mp4"), ("clip_suelto", 1))

    def test_build_teaser_sort_key_keeps_series_and_index_order(self):
        names = [
            "20260414_170022_teaser_002.mp4",
            "20260414_170022_teaser_000.mp4",
            "20260414_170022_teaser_001.mp4",
            "20260415_090000_teaser_000.mp4",
        ]

        ordered = sorted(names, key=build_teaser_sort_key)
