...
1. **Agente YouTube (`START_AGENT_youtube.ps1`)**:
   - Actúa sobre la bandeja principal (`/media/zerausn/D69493CF9493B08B/Users/ZN-/Documents/ADM/Carpeta 1`).
...
Gracias a estos agentes infinitos, **tu única labor diaria es arrastrar tus videos a `/media/zerausn/D69493CF9493B08B/Users/ZN-/Documents/ADM/Carpeta 1`**. El sistema hará lo siguiente:
...
Start-Process python -ArgumentList "uploader.py" -WorkingDirectory "/home/zerausn/Documents/Antigravity/agentes\youtube_uploader" -WindowStyle Hidden; 
Start-Process "/media/zerausn/D69493CF9493B08B/Users/ZN-/Documents\Antigravity\.venv\Scripts\python.exe" -ArgumentList "/home/zerausn/Documents/Antigravity/agentes\meta_uploader\schedule_jornada1_supervisor.py", "--days", "400" -WorkingDirectory "/home/zerausn/Documents/Antigravity/agentes\meta_uploader" -WindowStyle Hidden; 
Start-Process python -ArgumentList "periodic_mover.py" -WorkingDirectory "/home/zerausn/Documents/Antigravity/agentes\youtube_uploader" -WindowStyle Hidden
```
